...
input_data = team_data[
    [
        ...
        "trueskill_diff",
        "trueskill_win_perc",
        "egpm_dominance_ema_before",
        "egpm_dominance_diff",
        "egpm_dominance_win_perc",
        "blue_side_ema_before",
        "red_side_ema_before",
        "kills_ema_before",
        "deaths_ema_before",
        "assists_ema_before",
        "earned gpm_ema_before",
        "gamelength_ema_before",
        "dragons_ema_before",
        "barons_ema_before",
        "towers_ema_before",
        "csdiffat15_ema_before",
        "golddiffat15_ema_before",
        "xpdiffat15_ema_before",
        "dkpoints_ema_before",
    ]
].copy()
