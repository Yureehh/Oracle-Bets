...
- `config/data_ingestion/leagues_handling/considered_leagues.json` - leagues, taxonomy, and tiers.
- `config/data_ingestion/leagues_handling/league_prior_settings.json` - league prior calibration.
