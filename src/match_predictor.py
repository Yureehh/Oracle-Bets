    ...
    match = pd.DataFrame(
        {
            ...
            "player_trueskill": [
                trueskill_prediction(
                    blue.player_trueskill_mu,
            ...
            "team_egpm_dom": [
                egpm_dom_prediction(blue.team_egpm_dom, red.team_egpm_dom)
            ],
            "player_egpm_dom": [
                standard_prediction(blue.player_egpm_dom, red.player_egpm_dom)
            ],
...
def predict(
    ...
    red = Team(
        name=red_team, side="Red", top=red1, jng=red2, mid=red3, bot=red4, sup=red5
    )
...
def mock_draft(
    ...
    red = Team(
        name="Second 5", side="Red", top=red1, jng=red2, mid=red3, bot=red4, sup=red5
    )
    ...
    output = (
        "```Mock Draft!"
        f"\nBlue Team: {blue.top}, {blue.jng}, {blue.mid}, {blue.bot}, {blue.sup}"
        f"\nRed Team: {red.top}, {red.jng}, {red.mid}, {red.bot}, {red.sup}"
        f"\n\nBlue Team Win Probability: {output.blue_win_chance.iloc[0]:.3f}```"
    )
